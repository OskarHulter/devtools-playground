...
} from "@sln/features/insights/components";
import { FiltersProvider } from "@sln/features/insights/context/FiltersProvider";
import { Filters } from "@sln/features/insights/filters";
...
import { Button, ButtonGroup } from "@sln/ui";
					...
					buttons={
						<div className="space-y-2 rtl:space-x-reverse sm:space-x-2">
							<ButtonGroup>
								...
								<Button
									color="minimal"
									href="https://go.stresslessness.org/insights"
									target="_blank"
								>
									{t("learn_more")}
								</Button>
							...
							<div className="mb-4 space-y-4">
								...
								<small className="text-default block text-center">
									...
									<a
										...
										href="mailto:updates@stresslessness.org?subject=Feature%20Request%3A%20More%20Analytics&body=Hey%20stresslessness.org%20Team%2C%20I%20love%20the%20analytics%20page%20but%20I%20am%20looking%20for%20..."
									>
										{" "}
										{t("contact_support")}
									</a>
