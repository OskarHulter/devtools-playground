...
const pages = (exports.pages = glob
...
const subdomainRegExp = (exports.subdomainRegExp = getSubdomainRegExp(
...
function getRegExpMatchingAllReservedRoutes(suffix) {
	...
	const otherNonExistingRoutePrefixes = [
		"forms",
		"router",
		"success",
		"cancel",
	...
	const beforeRewriteExcludePages = pages
