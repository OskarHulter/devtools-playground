...
import type { BookerLayout } from "@sln/features/bookings/Booker/types";
...
export const tabs = [
  ...
  // yarn add @sln/embed-react

  /* If you are using npm */
  // npm install @sln/embed-react
  ${getEmbedTypeSpecificString({
...
function useGetEmbedSnippetString(namespace: string | null) {
  const bookerUrl = useBookerUrl();
  // TODO: Import this string from @sln/embed-snippet
