...
import { AvailableTimes, AvailableTimesHeader } from "@sln/features/bookings";
import {
  useBookerStore,
...
import { useTimePreferences } from "@sln/features/bookings/lib/timePreferences";
import DatePicker from "@sln/features/calendars/DatePicker";
import { useNonEmptyScheduleDays } from "@sln/features/schedules";
import { useSlotsForDate } from "@sln/features/schedules/lib/use-schedule/useSlotsForDate";
...
const ThemeSelectControl = ({
  children,
  ...props
}: ControlProps<{ value: Theme; label: string }, false>) => {
  return (
    ...
    <div className="flex h-full items-center justify-center border p-5 last:font-medium">
      <div className="border bg-white p-4">
        ...
        >
          ...
          >
            {t("duration")}:{" "}
            <b style={{ color: "black" }}>{eventType.length} mins</b>
          </div>
          <div>
            <b style={{ color: "black" }}>
              <span
                ...
                if (embedType !== "email") {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={
                          searchParams?.get("embedTabName") === "embed-preview"
                            ? "mt-2 block"
                            : "hidden"
                        }
                      />
