import type { EventLocationType } from "@sln/core/location";
import type { ChildrenEventType } from "@sln/features/eventtypes/components/ChildrenEventTypeSelect";
import type { PeriodType, SchedulingType } from "@sln/prisma/enums";
import type {
  BookerLayoutSettings,
  EventTypeMetaDataSchema,
} from "@sln/prisma/zod-utils";
import type { customInputSchema } from "@sln/prisma/zod-utils";
import type { eventTypeBookingFields } from "@sln/prisma/zod-utils";
import type { RouterOutputs } from "@sln/trpc/react";
import type { IntervalLimit, RecurringEvent } from "@sln/types/Calendar";
...
export type LocationFormValues = Pick<
  FormValues,
  "id" | "locations" | "bookingFields" | "seatsPerTimeSlot"
>;
