...
export type BookingResponse = Awaited<
  ReturnType<
    typeof import("@sln/features/bookings/lib/handleNewBooking").default
  >
>;

export type InstantBookingResponse = Awaited<
  ReturnType<
    typeof import("@sln/features/instant-meeting/handleInstantMeeting").default
  >
>;

export type MarkNoShowResponse = Awaited<
  ReturnType<typeof import("@sln/features/handleMarkNoShow").default>
>;
