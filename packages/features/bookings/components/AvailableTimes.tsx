...
import type { IOutOfOfficeData } from "@sln/core/getUserAvailability";
import dayjs from "@sln/dayjs";
import { OutOfOfficeInSlots } from "@sln/features/bookings/Booker/components/OutOfOfficeInSlots";
import type { BookerEvent } from "@sln/features/bookings/types";
import type { Slots } from "@sln/features/schedules";
import { classNames } from "@sln/lib";
import { useLocale } from "@sln/lib/hooks/useLocale";
import { localStorage } from "@sln/lib/webstorage";
import type { IGetAvailableSlots } from "@sln/trpc/server/routers/viewer/slots/util";
import { Button, Icon, SkeletonText } from "@sln/ui";
