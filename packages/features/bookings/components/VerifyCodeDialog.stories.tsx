...
import { StorybookTrpcProvider } from "@sln/ui";
...
const meta: Meta<StoryArgs> = {
  ...
  argTypes: {
    isOpenDialog: {
      control: "boolean",
      description: "Indicates whether the dialog is open or not.",
    },
    setIsOpenDialog: {
      action: "setIsOpenDialog",
      description: "Function to set the dialog state.",
    },
    email: {
      control: "text",
      description: "Email to which the verification code was sent.",
    },
    onSuccess: {
      action: "onSuccess",
      description: "Callback function when verification succeeds.",
    },
