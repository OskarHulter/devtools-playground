...
export type BookingSeat = Prisma.BookingSeatGetPayload<{
...
export type NewSeatedBookingObject = {
  ...
  responses:
    | z.infer<ReturnType<typeof getBookingDataSchema>>["responses"]
    | null;
  workflows: Workflow[];
};

export type RescheduleSeatedBookingObject = NewSeatedBookingObject & {
