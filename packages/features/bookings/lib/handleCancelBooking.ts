...
import { workflowSelect } from "@sln/features/ee/workflows/lib/getAllWorkflows";
...
async function getBookingToDelete(
  id: number | undefined,
...
async function handler(req: CustomRequest) {
  ...
  for (const booking of updatedBookings) {
    ...
    workflowReminderPromises.push(
      deleteAllWorkflowReminders(booking.workflowReminders)
    );
  }
