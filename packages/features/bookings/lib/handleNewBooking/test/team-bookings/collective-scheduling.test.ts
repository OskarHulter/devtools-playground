...
import { OrganizerDefaultConferencingAppType } from "@sln/app-store/locations";
...
import { createOrganization } from "@sln/web/test/utils/bookingScenario/bookingScenario";
import {
...
describe("handleNewBooking", () => {
  ...
  describe("Team Events", () => {
    ...
    describe("Round Robin Assignment", () => {
      test(`successfully books contact owner if rr lead skip is enabled`, async ({
        emails,
      }) => {
        const handleNewBooking = (
          await import("@sln/features/bookings/lib/handleNewBooking")
