 ...
 *
 * see: https://github.com/calcom/oskarhulter.com/pull/10480
 *      https://github.com/calcom/oskarhulter.com/pull/10968
 */
...
import { expectBookingToBeInDatabase } from "@sln/web/test/utils/bookingScenario/expects";
  ...
  describe("Future Limits", () => {
    test(
      ...
      async () => {
        ...
        expect(() => handleNewBooking(req)).rejects.toThrowError(
