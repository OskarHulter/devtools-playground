...
import BookingPageTagManager from "@sln/app-store/BookingPageTagManager";
import dayjs from "@sln/dayjs";
import { getQueryParam } from "@sln/features/bookings/Booker/utils/query-param";
...
const PoweredBy = dynamic(() => import("@sln/ee/components/PoweredBy"));
const UnpublishedEntity = dynamic(() =>
  import("@sln/ui/components/unpublished-entity/UnpublishedEntity").then(
    (mod) => mod.UnpublishedEntity
  )
);
