...
import { Timezone as PlatformTimezoneSelect } from "@sln/atoms/monorepo";
import { useEmbedUiConfig, useIsEmbed } from "@sln/embed-core/embed-iframe";
import {
  EventDetails,
  EventMembers,
  EventMetaSkeleton,
  EventTitle,
} from "@sln/features/bookings";
import { SeatsAvailabilityText } from "@sln/features/bookings/components/SeatsAvailabilityText";
import { EventMetaBlock } from "@sln/features/bookings/components/event-meta/Details";
...
const WebTimezoneSelect = dynamic(
  () =>
    import("@sln/ui/components/form/timezone-select/TimezoneSelect").then(
