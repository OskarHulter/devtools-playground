...
import { AvailableTimes, AvailableTimesSkeleton } from "@sln/features/bookings";
import type { BookerEvent } from "@sln/features/bookings/types";
import { useNonEmptyScheduleDays } from "@sln/features/schedules";
import { useSlotsForAvailableDates } from "@sln/features/schedules/lib/use-schedule/useSlotsForDate";
      ...
      >
        ...
        {!isLoading &&
          ...
          slotsPerDay.map((slots) => (
            <div
              key={slots.date}
              className="scroll-bar h-full w-full overflow-y-auto overflow-x-hidden"
            >
              <AvailableTimes
