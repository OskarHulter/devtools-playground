 ...
 *
 * ```ts
 * import { useFlags } from "@sln/features/flags/hooks/useFlag"
 * import { FeatureProvider, useFlagMap } from @sln/features/flags/context/provider"
 *
 ...
 */
export function FeatureProvider<F extends Flags>(props: {
  value: F;
