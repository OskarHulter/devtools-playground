...
import { getSuccessPageLocationMessage } from "@sln/app-store/locations";
import dayjs from "@sln/dayjs";
import { sdkActionManager, useIsEmbed } from "@sln/embed-core/embed-iframe";
import { PayIcon } from "@sln/features/bookings/components/event-meta/PayIcon";
import { Price } from "@sln/features/bookings/components/event-meta/Price";
...
const PaypalPaymentComponent = dynamic(
  () =>
    import("@sln/app-store/paypal/components/PaypalPaymentComponent").then(
...
const AlbyPaymentComponent = dynamic(
  () =>
    import("@sln/app-store/alby/components/AlbyPaymentComponent").then(
      (m) => m.AlbyPaymentComponent
    ),
  {
    ssr: false,
  }
      ...
      <main className="mx-auto max-w-3xl py-24">
        <div className="fixed inset-0 z-50 overflow-y-auto scroll-auto">
          <div className="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
            <div
              className="inset-0 my-4 transition-opacity sm:my-0"
              aria-hidden="true"
            >
              <span
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="text-default mt-4 grid grid-cols-3 border-b border-t py-4 text-left dark:border-gray-900 dark:text-gray-300">
                      ...
                      <div className="font-medium">
                        {props.payment.paymentOption === "HOLD"
                          ? t("no_show_fee")
                          : t("price")}
                      </div>
