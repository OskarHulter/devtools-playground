...
import { doesBookingRequireConfirmation } from "@sln/features/bookings/lib/doesBookingRequireConfirmation";
...
import { HttpError as HttpCode } from "@sln/lib/http-error";
import logger from "@sln/lib/logger";
import { getBooking } from "@sln/lib/payment/getBooking";
import { handlePaymentSuccess } from "@sln/lib/payment/handlePaymentSuccess";
...
/**
 * @deprecated
 * We need to create a PaymentManager in `@sln/core`
