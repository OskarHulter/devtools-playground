...
import { getClientSecretFromPayment } from "@sln/features/ee/payments/pages/getClientSecretFromPayment";
...
export const getServerSideProps = async (
  ...
  if (
    (
      [BookingStatus.CANCELLED, BookingStatus.REJECTED] as BookingStatus[]
