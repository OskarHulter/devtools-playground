...
export const samlAudience = "https://saml.oskarhulter.com";
export const samlPath = "/api/auth/saml/callback";
export const oidcPath = "/api/auth/oidc";
export const clientSecretVerifier =
...
export const canAccess = async (
  ...
  if (!isSAMLLoginEnabled) {
    return {
      message:
        "To enable this feature, add value for `SAML_DATABASE_URL` and `SAML_ADMINS` to your `.env`",
      access: false,
    };
  }
