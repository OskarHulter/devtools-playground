import type { SSOConnection } from "@sln/ee/sso/lib/saml";
      ...
      <div className="flex flex-col space-y-3">
        ...
        <Dialog>
          ...
          <ConfirmationDialogContent
            ...
            confirmBtnText={t("delete_sso_configuration_confirmation", {
              connectionType,
            })}
        ...
        <div className="flex">
          ...
          <Tooltip side="top" content={t("copy_to_clipboard")}>
            ...
            >
              <Icon
                name="clipboard"
                className="text-muted h-5 w-5 ltr:mr-2 rtl:ml-2"
              />
              {t("copy")}
            </Button>
          </Tooltip>
