import ConnectionInfo from "@sln/ee/sso/components/ConnectionInfo";
import LicenseRequired from "@sln/features/ee/common/components/LicenseRequired";
import OIDCConnection from "@sln/features/ee/sso/components/OIDCConnection";
import SAMLConnection from "@sln/features/ee/sso/components/SAMLConnection";
import { useLocale } from "@sln/lib/hooks/useLocale";
import { trpc } from "@sln/trpc/react";
import { Meta, Alert, SkeletonContainer, SkeletonText } from "@sln/ui";
...
export default function SSOConfiguration({
  ...
  const {
    ...
    isPending,
    error,
  } = trpc.viewer.saml.get.useQuery({ teamId });
