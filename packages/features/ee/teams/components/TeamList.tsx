...
import { Card, Icon, showToast } from "@sln/ui";
              ...
              <div className="bg-subtle p-4" key={team.id}>
                <div className="grid-col-1 grid gap-2 md:grid-cols-3">
                  ...
                  <Card
                    ...
                    description={t(
                      "Right now, team member URLs are all over the place. Get a beautiful link and turn every email address into a scheduling link: anna@acme.com → acme.oskarhulter.com/anna"
                    )}
                    actionButton={{
                  ...
                  <Card
                    ...
                    actionButton={{
                      href: "https://i.oskarhulter.com/sales/enterprise",
                      child: t("learn_more"),
                    }}
                  />
                </div>
