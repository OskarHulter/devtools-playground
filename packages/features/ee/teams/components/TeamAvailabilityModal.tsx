...
import type { ITimezone } from "@sln/ui";
import { Avatar, DatePicker, Label, Select, TimezoneSelect } from "@sln/ui";
      ...
      <>
        <div className="grid h-[400px] grid-cols-2 space-x-11 rtl:space-x-reverse">
          <div className="col-span-1">
            ...
            <div>
              <div className="text-brand-900 mb-5 mt-4 text-2xl font-semibold">
                {t("availability")}
              </div>
              <DatePicker
                minDate={new Date()}
