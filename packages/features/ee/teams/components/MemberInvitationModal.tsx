...
import TeamInviteFromOrg from "@sln/ee/organizations/components/TeamInviteFromOrg";
import { classNames } from "@sln/lib";
import { IS_TEAM_BILLING_ENABLED, MAX_NB_INVITES } from "@sln/lib/constants";
...
import { isEmail } from "@sln/trpc/server/routers/viewer/teams/util";
import {
  Button,
  Dialog,
  DialogContent,
    ...
    >
      ...
      >
        ...
        <Form
          ...
          handleSubmit={(values) => props.onSubmit(values, resetFields)}
        >
              ...
              <Controller
                ...
                rules={{
                  ...
                  validate: (value) => {
                    ...
                    if (typeof value === "string" && isOrg && !isEmail(value))
                      return t("enter_email");
                    if (typeof value === "string")
                      return (
                        validateUniqueInvite(value) ||
                        t("member_already_invited")
                      );
                  },
                }}
                      ...
                      if (typeof ClipboardItem !== "undefined") {
                        const inviteLinkClipbardItem = new ClipboardItem({
                          "text/plain": new Promise(async (resolve) => {
                            ...
                            resolve(
                              new Blob([inviteLink], { type: "text/plain" })
                            );
                          }),
                        });
                        await navigator.clipboard.write([
                          inviteLinkClipbardItem,
                        ]);
                      } else {
