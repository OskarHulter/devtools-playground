...
import InviteLinkSettingsModal from "@sln/ee/teams/components/InviteLinkSettingsModal";
import MemberInvitationModal from "@sln/ee/teams/components/MemberInvitationModal";
import classNames from "@sln/lib/classNames";
import { getPlaceholderAvatar } from "@sln/lib/defaultAvatarImage";
import { getTeamUrlSync } from "@sln/lib/getBookerUrl/client";
...
export default function TeamListItem(props: Props) {
  ...
  const [openMemberInvitationModal, setOpenMemberInvitationModal] =
    useState(showDialog);
  const [openInviteLinkSettingsModal, setOpenInviteLinkSettingsModal] =
    useState(false);
  ...
  const acceptOrLeaveMutation = trpc.viewer.teams.acceptOrLeave.useMutation({
    onSuccess: (_data, variables) => {
      ...
      const isSubTeamOfDifferentOrg = team.parentId
        ? team.parentId != userOrganizationId
        : false;
      const isDifferentOrg =
        team.isOrganization && team.id !== userOrganizationId;
  ...
  const isAdmin =
    props.team.role === MembershipRole.OWNER ||
    props.team.role === MembershipRole.ADMIN;
    ...
    <li className="">
      ...
      <div
        className={classNames(
          ...
          !isInvitee && "hover:bg-muted group"
        )}
      >
        {!isInvitee ? (
          team.slug ? (
