...
import { Button, showToast, TextArea } from "@sln/ui";
    ...
    <div className="bg-default border-default w-full rounded-md">
      <div className="w-full py-5">
        ...
        <a
          ...
          href="https://oskarhulter.com/docs/"
          target="_blank"
      ...
      <div className="w-full p-5">
        ...
        <p className="text-default flex w-full py-2 text-sm font-medium">
          {t("comments")}
        </p>
      ...
      <div className="text-subtle bg-muted hidden w-full flex-col p-5 md:block">
        <p className="">
          {showIntercom ? t("no_support_needed") : t("specific_issue")}
        </p>
        <button
