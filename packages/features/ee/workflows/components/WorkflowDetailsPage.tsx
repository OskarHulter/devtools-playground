...
import type { WorkflowActions } from "@sln/prisma/enums";
import { WorkflowTemplates } from "@sln/prisma/enums";
...
export default function WorkflowDetailsPage(props: Props) {
  ...
  const addAction = (
    ...
    const step = {
      ...
      reminderBody: null,
      emailSubject: null,
      template: isWhatsappAction(action)
            ...
            render={() => {
              return (
                <MultiSelectCheckboxes
                  ...
                  selected={
                    form.getValues("selectAll") ? allOptions : selectedOptions
                  }
                  setValue={(s: Option[]) => {
