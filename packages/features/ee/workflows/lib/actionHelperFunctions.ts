...
import { WorkflowActions, WorkflowTemplates } from "@sln/prisma/enums";
...
export function getWhatsappTemplateForTrigger(
...
export function getWhatsappTemplateFunction(
