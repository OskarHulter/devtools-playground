...
From the [Original RFC](https://github.com/calcom/oskarhulter.com/issues/7142):
...
2.  Set the following environment variables as described:
    ...
    1. **`CALCOM_LICENSE_KEY`**: Since Organizations is an EE feature, a license key should be present, either as this environment variable or visiting as an Admin `/auth/setup`. To get a license key you should visit Cal Console ([prod](https://console.oskarhulter.com) or [dev](https://console.cal.dev))
