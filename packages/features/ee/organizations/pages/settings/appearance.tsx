...
import ThemeLabel from "@sln/features/settings/ThemeLabel";
import {
...
import { Button, Form, showToast, SettingsToggle } from "@sln/ui";
...
const OrgAppearanceViewWrapper = () => {
  ...
  const isAdminOrOwner =
    orgRole === MembershipRole.OWNER || orgRole === MembershipRole.ADMIN;
