...
import LicenseRequired from "@sln/ee/common/components/LicenseRequired";
    ...
    >
      ...
      >
        <Trans
          ...
          components={{
            li: <li />,
            ul: <ul className="ml-4 mt-5 list-disc space-y-2" />,
          }}
        >
          <ul>
            <li>
              Teams that are member of this organization will also be deleted
              along with their event-types
            </li>
            <li>
              Users that were part of the organization will not be deleted and
              their event-types will also remain intact.
            </li>
            <li>
              Usernames would be changed to allow them to exist outside the
              organization
            </li>
          </ul>
        </Trans>
