...
export const LockEventTypeSwitch = ({
  currentOrg,
  isAdminOrOwner,
}: GeneralViewProps) => {
              ...
              <div className="flex flex-row space-x-3">
                <div className="w-full pt-1">
                  ...
                  >
                    <RadioArea.Item
                      checked={
                        currentLockedOption === CurrentEventTypeOptions.HIDE
                      }
                    ...
                    <RadioArea.Item
                      checked={
                        currentLockedOption === CurrentEventTypeOptions.DELETE
                      }
                      value={CurrentEventTypeOptions.DELETE}
                      className={classNames(
                        "[&:has(input:checked)]:border-error h-full text-sm"
                      )}
                    >
                      <strong className="mb-1 block">
