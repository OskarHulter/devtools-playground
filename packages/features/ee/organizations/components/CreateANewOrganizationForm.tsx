import { subdomainSuffix } from "@sln/features/ee/organizations/lib/orgDomains";
import classNames from "@sln/lib/classNames";
import { MINIMUM_NUMBER_OF_ORG_SEATS } from "@sln/lib/constants";
          ...
          <>
            <div className="bg-subtle space-y-5  rounded-lg p-5">
              ...
              >
                ...
                <RadioArea.Item
                  className={classNames("bg-default w-full text-sm")}
                  value="ORGANIZATION"
                >
