...
import { EmptyScreen, Alert, Button } from "@sln/ui";
      ...
      {hasValidLicense === null || hasValidLicense ? (
        ...
        <>
          <Alert
            ...
            title={
              <>
                {t("enterprise_license_locally")}{" "}
                {t("enterprise_license_sales")}{" "}
                <a className="underline" href="https://oskarhulter.com/sales">
                  {t("contact_sales")}
                </a>
              </>
            }
        ...
        <EmptyScreen
          ...
          buttonRaw={
            <Button color="secondary" href="https://oskarhulter.com/sales">
              {t(`contact_sales`)}
            </Button>
          }
