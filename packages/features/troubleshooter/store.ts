import {
  ...
  getQueryParam,
  removeQueryParam,
} from "../bookings/Booker/utils/query-param";
 ...
 */
export const useTroubleshooterStore = create<TroubleshooterStore>(
  (set, get) => ({
...
export const useInitalizeTroubleshooterStore = ({
  month,
}: StoreInitializeType) => {
