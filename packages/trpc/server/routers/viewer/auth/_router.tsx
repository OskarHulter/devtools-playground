...
export const authRouter = router({
  ...
  sendVerifyEmailCode: publicProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      if (!UNSTABLE_HANDLER_CACHE.sendVerifyEmailCode) {
        UNSTABLE_HANDLER_CACHE.sendVerifyEmailCode = await import(
          "./sendVerifyEmailCode.handler"
        ).then((mod) => mod.sendVerifyEmailCodeHandler);
      }
  ...
  createAccountPassword: authedProcedure.mutation(async ({ ctx }) => {
    if (!UNSTABLE_HANDLER_CACHE.createAccountPassword) {
      UNSTABLE_HANDLER_CACHE.createAccountPassword = await import(
        "./createAccountPassword.handler"
      ).then((mod) => mod.createAccountPasswordHandler);
    }
