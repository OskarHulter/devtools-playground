...
import app_Basecamp3 from "@sln/app-store/basecamp3/trpc-router";
import app_RoutingForms from "@sln/app-store/routing-forms/trpc-router";
import { userAdminRouter } from "@sln/features/ee/users/server/trpc-router";
import { featureFlagRouter } from "@sln/features/flags/server/router";
import { insightsRouter } from "@sln/features/insights/server/trpc-router";
...
export const viewerRouter = mergeRouters(
  ...
  router({
    ...
    // NOTE: Add all app related routes in the bottom till the problem described in @sln/app-store/trpc-routers.ts is solved.
