...
import type { TDependencyData } from "@sln/app-store/_appRegistry";
import type { CredentialOwner } from "@sln/app-store/types";
import { getAppFromSlug } from "@sln/app-store/utils";
import getEnabledAppsFromCredentials from "@sln/lib/apps/getEnabledAppsFromCredentials";
import getInstallCountPerApp from "@sln/lib/apps/getInstallCountPerApp";
...
import type { PaymentApp } from "@sln/types/PaymentService";
...
type TeamQuery = Prisma.TeamGetPayload<{
  select: {
    id: true;
    credentials: {
      select: typeof import("@sln/prisma/selects/credential").credentialForCalendarServiceSelect;
    };
    name: true;
    logoUrl: true;
    members: {
