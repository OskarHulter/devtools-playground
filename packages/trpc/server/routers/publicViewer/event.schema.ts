...
export const ZEventInputSchema = z.object({
  ...
  /**
   * Informs that the event request has been sent from a page that was reached by a redirect from non-org link(i.e. app.oskarhulter.com/username redirected to acme.oskarhulter.com/username)
