...
import { Button, showToast, TextField } from "@sln/ui";
...
export default function PayPalSetup() {
  ...
  const showContent =
    !!integrations.data && integrations.isSuccess && !!credentialId;
  const saveKeysMutation =
    trpc.viewer.appsRouter.updateAppCredentials.useMutation({
      onSuccess: () => {
        ...
        <div className="bg-default border-subtle m-auto max-w-[43em] overflow-auto rounded border pb-10 md:p-10">
          <div className="ml-2 ltr:mr-2 rtl:ml-2 md:ml-5">
            <div className="invisible md:visible">
              <img
                className="h-11"
                src="/api/app-store/paypal/icon.svg"
            ...
            <div>
              <p className="text-lgf text-default mt-5 font-bold">
                Getting started with Paypal APP
              </p>
              <p className="text-default font-semi mt-2">
                Here in Cal.com we offer Paypal as one of our payment gateway.
                You can use your own Paypal Business account to receive payments
                from your customers enabling and setting up price and currency
              ...
              <p className="text-default font-semi mt-2">
                Remember to only proceed with the following steps if your
                account has already been upgraded to a business account. Also
                keep in mind that some of the following steps might be different
              ...
              <ol className="text-default ml-1 mt-5 list-decimal pl-2">
                ...
                <li>
                  Copy the Client ID and Secret Key using copy buttons one by
                  one.
                </li>
              ...
              <p className="text-default mt-2">
                Our integration creates a specific webhook on your Paypal
                account that we use to report back transactions to our system.
                If you delete this webhook, we will not be able to report back
                and you should Uninstall and Install the app again for this to
                work again. Uninstalling the app won&apos;t delete your current
                event type price/currency configuration but you would not be
