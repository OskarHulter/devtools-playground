import type { EventTypeFormMetadataSchema } from "@sln/prisma/zod-utils";
...
export type EventTypeAppCardApp =
  RouterOutputs["viewer"]["integrations"]["items"][number] & {
...
export type EventTypeAppCardComponent =
  React.FC<EventTypeAppCardComponentProps>;

export type EventTypeAppSettingsComponent =
  React.FC<EventTypeAppSettingsComponentProps>;
