...
async function postHandler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (
    ...
    req.body.token === open_verification_token
  ) {
  ...
  if (
    ...
    open_verification_token === req.body.token
  ) {
    const {
      body: {
  ...
  // used for handle user at bot in feishu chat with oskarhulter.com connector bot, see
  ...
  // used for handle user first talk with oskarhulter.com connector bot, see
