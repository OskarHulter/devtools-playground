...
import SkeletonLoaderTeamList from "@sln/features/ee/teams/components/SkeletonloaderTeamList";
import { FilterResults } from "@sln/features/filters/components/FilterResults";
import { TeamsFilter } from "@sln/features/filters/components/TeamsFilter";
import { getTeamsFiltersFromQuery } from "@sln/features/filters/lib/getTeamsFiltersFromQuery";
import Shell, { ShellMain } from "@sln/features/shell/Shell";
import { UpgradeTip } from "@sln/features/tips";
          ...
          buttons={
            <div className="space-y-2 rtl:space-x-reverse sm:space-x-2">
              <ButtonGroup>
                ...
                <Button
                  color="minimal"
                  href="https://go.oskarhulter.com/teams-video"
                  target="_blank"
                >
                  {t("learn_more")}
                </Button>
