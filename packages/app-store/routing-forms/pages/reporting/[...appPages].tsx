...
type QueryBuilderUpdatedConfig = typeof QueryBuilderInitialConfig & {
...
const Reporter = ({
  ...
  const [jsonLogicQuery, setJsonLogicQuery] = useState<JsonLogicResult | null>(
    null
  );
  const onChange = (
  ...
  return (
    <div className="cal-query-builder bg-default fixed inset-0 w-full overflow-scroll pt-12 ltr:mr-2 rtl:ml-2 sm:pt-0">
      ...
      <Result
        formId={form.id}
        jsonLogicQuery={jsonLogicQuery as JsonLogicQuery}
      />
    </div>
  );
};
