import { Button as CalButton, TextField, TextArea } from "@sln/ui";
...
const Select = dynamic(
  async () => (await import("@sln/ui")).SelectWithValidation
) as unknown as typeof import("@sln/ui").SelectWithValidation;
...
export type SelectLikeComponentPropsRAQB<
  TVal extends string | string[] = string
> = {
  listValues: { title: string; value: TVal extends (infer P)[] ? P : TVal }[];
} & CommonProps<TVal>;

export type TextLikeComponentProps<
  TVal extends string | string[] | boolean = string
> = CommonProps<TVal> & {
  name?: string;
};
...
const MultiSelectWidget = ({
  ...
  const optionsFromList = selectItems.filter((item) =>
