...
import { Switch, Badge, Avatar, Button, Icon } from "@sln/ui";
...
export default function AppCard({
  ...
  return (
    ...
    >
      <div
        className={classNames(
          app.isInstalled ? "p-4 text-sm sm:p-4" : "px-5 py-4 text-sm sm:px-5"
        )}
      >
        <div className="flex w-full flex-col gap-2 sm:flex-row sm:gap-0">
          ...
          <Link
            href={`/apps/${app.slug}`}
            className={classNames(
              app?.isInstalled ? "mr-[11px]" : "mr-3",
              "h-auto w-10 rounded-sm"
            )}
          >
            <img
              className={classNames(
          ...
          <div className="flex flex-col pe-3">
            ...
            <p
              ...
              className="text-default line-clamp-1 pt-1 text-sm font-normal"
            >
