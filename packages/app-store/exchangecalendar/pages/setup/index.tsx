...
export default function ExchangeSetup() {
  ...
  const authenticationMethods = [
    {
      value: ExchangeAuthentication.STANDARD,
      label: t("exchange_authentication_standard"),
    },
    {
      value: ExchangeAuthentication.NTLM,
      label: t("exchange_authentication_ntlm"),
    },
  ];
  const exchangeVersions = [
    {
      value: ExchangeVersion.Exchange2007_SP1,
      label: t("exchange_version_2007_SP1"),
    },
    { value: ExchangeVersion.Exchange2010, label: t("exchange_version_2010") },
    {
      value: ExchangeVersion.Exchange2010_SP1,
      label: t("exchange_version_2010_SP1"),
    },
    {
      value: ExchangeVersion.Exchange2010_SP2,
      label: t("exchange_version_2010_SP2"),
    },
    { value: ExchangeVersion.Exchange2013, label: t("exchange_version_2013") },
    {
      value: ExchangeVersion.Exchange2013_SP1,
      label: t("exchange_version_2013_SP1"),
    },
                ...
                <Form
                  ...
                  handleSubmit={async (values) => {
                    ...
                    const res = await fetch(
                      "/api/integrations/exchangecalendar/add",
                      {
                        method: "POST",
                    ...
                    if (!res.ok) {
                      setErrorMessage(
                        json?.message || t("something_went_wrong")
                      );
                    } else {
