import { Button, Select, showToast } from "@sln/ui";
...
const AppConfiguration = (props: IAppConfigurationProps) => {
  ...
  return (
    <div className="flex-col items-start p-3 text-sm">
      ...
      <p className="mt-1">
        You can select different parameters to trigger the reschedule based on
        your sleeping metrics.
      </p>
        ...
        <Button
          ...
          onClick={async () => {
            try {
              ...
              showToast(
                "An error ocurred saving your Vital Configurations",
                "error"
              );
