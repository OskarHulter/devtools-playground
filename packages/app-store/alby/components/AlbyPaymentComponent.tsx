import type { PaymentPageProps } from "@sln/features/ee/payments/pages/payment";
...
import { useCopy } from "@sln/lib/hooks/useCopy";
import { useLocale } from "@sln/lib/hooks/useLocale";
import { trpc } from "@sln/trpc";
import { Button, showToast } from "@sln/ui";
import { Spinner } from "@sln/ui/components/icon/Spinner";
          ...
          {showQRCode && (
            <>
              ...
              <Link
                ...
                className="link mt-4 text-sm underline"
              >
    ...
    const interval = setInterval(() => {
      (async () => {
        ...
        const { booking: bookingResult } =
          await utils.viewer.bookings.find.fetch({
