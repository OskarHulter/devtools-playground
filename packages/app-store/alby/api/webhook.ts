import { albyCredentialKeysSchema } from "@sln/app-store/alby/lib";
import parseInvoice from "@sln/app-store/alby/lib/parseInvoice";
...
export default async function handler(
  ...
  try {
    ...
    if (parsedPayload.metadata?.payer_data?.appId !== "oskarhulter.com") {
      throw new HttpCode({
        statusCode: 204,
        message: "Payment not for oskarhulter.com",
      });
    }
