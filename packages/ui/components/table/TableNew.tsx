  ...
  <div className="w-full overflow-auto md:overflow-visible">
    <table
      ...
      className={classNames(
        "border-subtle w-full caption-bottom border text-sm",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={classNames(
      "[&_tr]:bg-subtle md:z-10 [&_tr]:border-b",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={classNames(
      "text-default px-2 py-2.5 align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={classNames("text-default mt-4 text-sm", className)}
    {...props}
  />
));
