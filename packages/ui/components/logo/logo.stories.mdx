...
<Examples>
  <Example title="Default">
    <Logo src={"https://app.oskarhulter.com/api/logo"} />
  </Example>
  <Example title="Small">
    <Logo src={"https://app.oskarhulter.com/api/logo"} small />
  </Example>
  <Example title="As an Icon">
    <Logo src={"https://app.oskarhulter.com/api/logo"} icon />
  </Example>
</Examples>
...
<Canvas>
  <Story
    ...
    args={{
      icon: false,
      src: "https://app.oskarhulter.com/api/logo",
      small: false,
    }}>
    {(args) => (
