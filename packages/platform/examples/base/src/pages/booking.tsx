...
import { Booker, useEventTypes } from "@sln/atoms";
...
export default function Bookings(props: {
  ...
  const [eventTypeDuration, setEventTypeDuration] = useState<number | null>(
    null
  );
    ...
    >
      ...
      <div>
        <h1 className="mx-10 my-4 text-2xl font-semibold">
          {props.calUsername} Public Booking Page
        </h1>
                ...
                (event: {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p>{`/${event.slug}`}</p>
                      <span className="border-none bg-gray-800 px-2 text-white">
        ...
        {!bookingTitle && eventTypeSlug && !rescheduleUid && (
          <Booker
            ...
            customClassNames={{
              bookerContainer:
                "!bg-[#F5F2FE] [&_button:!rounded-full] border-subtle border",
