...
import { X_CAL_SECRET_KEY } from "@sln/platform-constants";
...
// example endpoint to create a managed oskarhulter.com user
export default async function handler(
  ...
  const response = await fetch(
    ...
    `${process.env.NEXT_PUBLIC_CALCOM_API_URL ?? ""}/oauth-clients/${
