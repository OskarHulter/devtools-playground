...
import type { API_VERSIONS_ENUM } from "@sln/platform-constants";
import { VERSION_2024_06_14 } from "@sln/platform-constants";
import type deTranslations from "@sln/web/public/static/locales/de/common.json";
import type enTranslations from "@sln/web/public/static/locales/en/common.json";
import type esTranslations from "@sln/web/public/static/locales/es/common.json";
import type frTranslations from "@sln/web/public/static/locales/fr/common.json";
import type ptBrTranslations from "@sln/web/public/static/locales/pt-BR/common.json";
 ...
 * @param {string} [options.apiUrl] - The API URL. https://api.oskarhulter.com/v2
