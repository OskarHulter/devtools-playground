...
import deTranslations from "@sln/web/public/static/locales/de/common.json";
import enTranslations from "@sln/web/public/static/locales/en/common.json";
import esTranslations from "@sln/web/public/static/locales/es/common.json";
import frTranslations from "@sln/web/public/static/locales/fr/common.json";
import ptBrTranslations from "@sln/web/public/static/locales/pt-BR/common.json";
  ...
  const translations = {
    t: (
      ...
      let translation =
        ...
        String(getTranslation(key, language) ?? "");
      if (!translation) {
        return "";
      }
      if (values) {
    ...
    i18n: {
      ...
      locales: [language],
      exists: (key: translationKeys | string) =>
        Boolean(enTranslations[key as translationKeys]),
    },
  };
