...
import { sdkActionManager } from "@sln/embed-core/embed-iframe";
import type { BookerProps } from "@sln/features/bookings/Booker";
import { Booker as BookerComponent } from "@sln/features/bookings/Booker";
import { useBookerLayout } from "@sln/features/bookings/Booker/components/hooks/useBookerLayout";
import { useBookingForm } from "@sln/features/bookings/Booker/components/hooks/useBookingForm";
import { useBookings } from "@sln/features/bookings/Booker/components/hooks/useBookings";
import { useCalendars } from "@sln/features/bookings/Booker/components/hooks/useCalendars";
import { useSlots } from "@sln/features/bookings/Booker/components/hooks/useSlots";
import { useVerifyCode } from "@sln/features/bookings/Booker/components/hooks/useVerifyCode";
import { useVerifyEmail } from "@sln/features/bookings/Booker/components/hooks/useVerifyEmail";
import {
  useBookerStore,
  useInitializeBookerStore,
} from "@sln/features/bookings/Booker/store";
import {
  useEvent,
  useScheduleForEvent,
} from "@sln/features/bookings/Booker/utils/event";
import { useBrandColors } from "@sln/features/bookings/Booker/utils/use-brand-colors";
import {
  DEFAULT_LIGHT_BRAND_COLOR,
  DEFAULT_DARK_BRAND_COLOR,
} from "@sln/lib/constants";
import { useRouterQuery } from "@sln/lib/hooks/useRouterQuery";
import { BookerLayouts } from "@sln/prisma/zod-utils";
