...
describe("mergeOverlappingDateRanges", () => {
  it("should merge all ranges into one when one range includes all others", () => {
    const dateRanges = [
      createDateRange(
        `${november2}T23:00:00.000Z`,
        `${november3}T07:00:00.000Z`
      ), // Includes all others
      createDateRange(
        `${november2}T23:15:00.000Z`,
        `${november3}T00:00:00.000Z`
      ),
      createDateRange(
        `${november3}T00:15:00.000Z`,
        `${november3}T01:00:00.000Z`
      ),
      createDateRange(
        `${november3}T01:15:00.000Z`,
        `${november3}T02:00:00.000Z`
      ),
    ];
  ...
  it("should merge only overlapping ranges over 2 days and leave non-overlapping ranges as is", () => {
    const dateRanges = [
      ...
      createDateRange(
        `${november3}T05:00:00.000Z`,
        `${november3}T06:00:00.000Z`
      ),
      createDateRange(
        `${november3}T08:00:00.000Z`,
        `${november3}T10:00:00.000Z`
      ), // This range should not be merged
    ];
  ...
  it("should merge ranges that overlap on the same day", () => {
    const dateRanges = [
      createDateRange(
        `${november2}T01:00:00.000Z`,
        `${november2}T04:00:00.000Z`
      ),
      createDateRange(
        `${november2}T02:00:00.000Z`,
        `${november2}T03:00:00.000Z`
      ), // This overlaps with the first range
      createDateRange(
        `${november2}T05:00:00.000Z`,
        `${november2}T06:00:00.000Z`
      ), // This doesn't overlap with above
    ];
