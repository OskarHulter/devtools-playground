...
import { appDataSchemas } from "@sln/app-store/apps.schemas.generated";
import dayjs from "@sln/dayjs";
import { isPasswordValid } from "@sln/features/auth/lib/isPasswordValid";
import type { FieldType as FormBuilderFieldType } from "@sln/features/form-builder/schema";
import { fieldsSchema as formBuilderFieldsSchema } from "@sln/features/form-builder/schema";
import { isSupportedTimeZone } from "@sln/lib/date-fns";
...
import type { AnyZodObject, objectInputType, objectOutputType, ZodNullableDef, ZodOptionalDef, ZodRawShape, ZodTypeAny } from "zod";
...
export const DeploymentTheme = z
  .object({
    ...
    fontSrc: z.string().default("https://oskarhulter.com/cal.ttf"),
  })
  .optional();
