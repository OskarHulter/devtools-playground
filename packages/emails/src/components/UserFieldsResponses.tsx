...
import getLabelValueMapFromResponses from "@sln/lib/getLabelValueMapFromResponses";
import type { CalendarEvent } from "@sln/types/Calendar";

import { Info } from "./Info";

export function UserFieldsResponses(props: {
  calEvent: CalendarEvent;
  t: TFunction;
  isOrganizer?: boolean;
}) {
  const { t, isOrganizer = false } = props;
  const labelValueMap = getLabelValueMapFromResponses(
    props.calEvent,
    isOrganizer
  );
