...
import { BASE_URL, IS_PRODUCTION } from "@sln/lib/constants";
  ...
  switch (headerType) {
    case "checkCircle":
      return IS_PRODUCTION
        ...
        : "https://app.oskarhulter.com/emails/checkCircle@2x.png";
    case "xCircle":
      return IS_PRODUCTION
        ? `${BASE_URL}/emails/xCircle@2x.png`
        : "https://app.oskarhulter.com/emails/xCircle@2x.png";
    case "calendarCircle":
      return IS_PRODUCTION
        ? `${BASE_URL}/emails/calendarCircle@2x.png`
        : "https://app.oskarhulter.com/emails/calendarCircle@2x.png";
    case "teamCircle":
      return IS_PRODUCTION
        ? `${BASE_URL}/emails/teamCircle@2x.png`
        : "https://app.oskarhulter.com/emails/teamCircle@2x.png";
  }
};
