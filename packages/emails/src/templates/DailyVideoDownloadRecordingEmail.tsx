...
import { WEBAPP_URL, APP_NAME, COMPANY_NAME } from "@sln/lib/constants";
...
export const DailyVideoDownloadRecordingEmail = (
  props: DailyVideoDownloadRecordingEmailProps &
  ...
  return (
    ...
    >
      ...
      >
        ...
        <CallToAction
          label={props.language("download_recording")}
      ...
      <p style={{ fontWeight: 500, lineHeight: "20px", marginTop: "8px" }}>
        <Trans i18nKey="link_valid_for_12_hrs">
          Note: The download link is valid only for 12 hours. You can generate
          new download link by following instructions
          <a href="https://oskarhulter.com/docs/enterprise-features/teams/cal-video-recordings">
            {" "}
            here
          </a>
        </Trans>
