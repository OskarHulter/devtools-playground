  ...
  return (
    ...
    >
      <div>
        ...
        <p
          style={{ fontWeight: "normal", fontSize: "16px", lineHeight: "24px" }}
        >
        ...
        >
          {props.language(
            "summary_of_events_for_your_team_for_the_last_30_days",
            {
        ...
        >
          ...
          >
            <p style={{ fontWeight: 500 }}>
              {props.language("most_popular_events")}
            </p>
            ...
            ? props.mostBookedEvents.map((ev, idx) => (
                <div
                  ...
                  style={{
                    ...
                    justifyContent: "space-between",
                    borderBottom: `${
                      idx === props.mostBookedEvents.length - 1
                        ? ""
                        : "1px solid #D1D5DB"
                    }`,
                  }}
        ...
        <div style={{ width: "100%", marginTop: "30px" }}>
          ...
          >
            <p style={{ fontWeight: 500 }}>
              {props.language("most_booked_members")}
            </p>
            <p style={{ fontWeight: 500 }}>{props.language("bookings")}</p>
          </div>
            ...
            ? props.membersWithMostBookings.map((it, idx) => (
                <div
                  ...
                  style={{
                    ...
                    justifyContent: "space-between",
                    borderBottom: `${
                      idx === props.membersWithMostBookings.length - 1
                        ? ""
                        : "1px solid #D1D5DB"
                    }`,
                  }}
