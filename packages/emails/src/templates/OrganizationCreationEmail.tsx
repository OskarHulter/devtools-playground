...
import { APP_NAME, WEBAPP_URL } from "@sln/lib/constants";
...
export const OrganizationCreationEmail = (
  props: OrganizationCreation &
    Partial<React.ComponentProps<typeof V2BaseEmailHtml>>
) => {
  ...
  return (
    <V2BaseEmailHtml
      subject={props.language(`email_organization_created|subject`)}
    >
      <p
      ...
      >
        You have been added as an owner of the organization. To publish your new
        organization, visit{" "}
      ...
      >
        {isNewUser ? (
          <Trans>
            Enjoy your new organization link:{" "}
          ...
          <Trans i18nKey="email|existing_user_added_link_changed">
            ...
            <a href={newLink ?? ""}>{newLinkWithoutProtocol}</a> but don&apos;t
            worry, all previous links still work and redirect appropriately.
            <br />
            <br />
            Please note: All of your personal event types have been moved into
            the <strong>{teamName}</strong> organisation, which may also include
            potential personal link.
            <br />
            <br />
            Please log in and make sure you have no private events on your new
