...
import { serverConfig } from "@sln/lib/serverConfig";
import { setTestEmail } from "@sln/lib/testEmails";
  ...
  public async sendEmail() {
    ...
    if (emailsDisabled) {
      ...
      return new Promise((r) =>
        r("Skipped Sending Email due to active Kill Switch")
      );
    }
    ...
    await new Promise((resolve, reject) =>
      ...
      console.error(
        "sendEmail",
        `from: ${
          "from" in payloadWithUnEscapedSubject
            ? payloadWithUnEscapedSubject.from
            : ""
        }`,
        `subject: ${
          "subject" in payloadWithUnEscapedSubject
            ? payloadWithUnEscapedSubject.subject
            : ""
        }`,
        e
      )
