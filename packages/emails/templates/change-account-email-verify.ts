...
import { APP_NAME, COMPANY_NAME, EMAIL_FROM_NAME } from "@sln/lib/constants";
...
${this.changeEvent.language("hi_user_name", {
  name: this.changeEvent.user.name,
})},
${this.changeEvent.language("verify_email_change_description", {
  appName: APP_NAME,
})}
...
${this.changeEvent.language("happy_scheduling")} ${this.changeEvent.language(
      "the_calcom_team",
      {
