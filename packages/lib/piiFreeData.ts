...
export function getPiiFreeSelectedCalendar(
  selectedCalendar: Partial<SelectedCalendar>
) {
  return {
...
export function getPiiFreeDestinationCalendar(
...
export function getPiiFreeEventType(
  eventType: Partial<Omit<EventType, "recurringEvent">>
) {
  return {
    id: eventType.id,
