...
import { getEventTypeAppData } from "@sln/app-store/utils";
import type { LocationObject } from "@sln/core/location";
...
import { SchedulingType, MembershipRole } from "@sln/prisma/enums";
import {
  customInputSchema,
...
export const getEventTypeById = async ({
  ...
  const eventTypeWithParsedMetadata = {
    ...rawEventType,
