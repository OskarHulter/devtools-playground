...
import { yyyymmdd } from "@sln/lib/date-fns";
...
export function transformAvailabilityForAtom(schedule: {
  availability: ScheduleAvailability;
}) {
...
export const transformScheduleToAvailabilityForAtom = (schedule: {
  availability: ScheduleAvailability;
}) => {
