import type { ScheduleAvailabilityInput_2024_06_11 } from "@sln/platform-types/schedules/schedules-2024-06-11";
import type { ScheduleOverrideInput_2024_06_11 } from "@sln/platform-types/schedules/schedules-2024-06-11";
import type { WeekDay } from "@sln/platform-types/schedules/schedules-2024-06-11";

export function transformApiScheduleAvailability(
  inputAvailability: ScheduleAvailabilityInput_2024_06_11[]
) {
...
export function transformApiScheduleOverrides(
  inputOverrides: ScheduleOverrideInput_2024_06_11[]
) {
