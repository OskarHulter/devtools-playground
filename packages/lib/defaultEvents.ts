...
import { PeriodType, SchedulingType } from "@sln/prisma/enums";
import type { userSelect } from "@sln/prisma/selects";
...
export const getDynamicEventName = (
  ...
  return `Dynamic Collective ${slug} min event with ${dynamicNames.join(
    ", "
  )} & ${lastUser}`;
};
...
export type AwaitedGetDefaultEvent = Awaited<
  ReturnType<typeof getDefaultEvent>
>;
