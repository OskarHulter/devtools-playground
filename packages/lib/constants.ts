...
export const WEBSITE_URL =
  process.env.NEXT_PUBLIC_WEBSITE_URL || "https://oskarhulter.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Cal.com";
export const SUPPORT_MAIL_ADDRESS =
  process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@oskarhulter.com";
...
// Use website URL to make links shorter(oskarhulter.com and not app.oskarhulter.com)
...
export const IS_CALCOM =
  WEBAPP_URL &&
  (new URL(WEBAPP_URL).hostname.endsWith("oskarhulter.com") ||
...
export const ROADMAP = "https://oskarhulter.com/roadmap";
export const DESKTOP_APP_LINK = "https://oskarhulter.com/download";
export const JOIN_DISCORD = "https://go.oskarhulter.com/discord";
export const POWERED_BY_URL = `${WEBSITE_URL}/?utm_source=embed&utm_medium=powered-by-button`;
export const DOCS_URL = "https://oskarhulter.com/docs";
export const DEVELOPER_DOCS = "https://developer.oskarhulter.com";
...
export const FUTURE_ROUTES_OVERRIDE_COOKIE_NAME =
  "x-calcom-future-routes-override";
export const FUTURE_ROUTES_ENABLED_COOKIE_NAME =
  "x-calcom-future-routes-enabled";
