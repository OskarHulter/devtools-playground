...
export const createConsoleUser = async (
  user: ConsoleUserInfoType | null | undefined
) => {
  if (user) {
...
export const deleteWebUser = async (
  user: WebUserInfoType | null | undefined
) => {
  if (user) {
...
export const closeComDeleteTeamMembership = async (
  user: WebUserInfoType | null | undefined
) => {
  if (user) {
...
export const closeComUpdateTeam = async (
  prevTeam: TeamInfoType,
  updatedTeam: TeamInfoType
) => {
