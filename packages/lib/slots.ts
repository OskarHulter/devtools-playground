...
import type { IFromUser, IOutOfOfficeData, IToUser } from "@sln/core/getUserAvailability";
import type { Dayjs } from "@sln/dayjs";
import dayjs from "@sln/dayjs";
import type { WorkingHours, TimeRange as DateOverride } from "@sln/types/schedule";
...
function buildSlots({
  ...
  for (const item of Object.values(slotsTimeFrameAvailable)) {
    /*
     * @sln/web:dev: 2022-11-06T00:00:00-04:00
     * @sln/web:dev: 2022-11-06T01:00:00-04:00
     * @sln/web:dev: 2022-11-06T01:00:00-04:00 <-- note there is no offset change, but we did lose an hour.
     * @sln/web:dev: 2022-11-06T02:00:00-04:00
     * @sln/web:dev: 2022-11-06T03:00:00-04:00
     * ...
     */
    slots.push({
...
function buildSlotsWithDateRanges({
  ...
  let interval =
    Number(process.env.NEXT_PUBLIC_AVAILABILITY_SCHEDULE_INTERVAL) || 1;
