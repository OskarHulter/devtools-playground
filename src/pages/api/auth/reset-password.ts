...
import { validPassword } from "@sln/features/auth/lib/validPassword";
...
export default async function handler(
	...
	const { password: rawPassword, requestId: rawRequestId } =
	...
	// never existed within SLN. In this case we do not want to disclose the email's existence.
