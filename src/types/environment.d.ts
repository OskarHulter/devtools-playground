declare namespace NodeJS {
	interface ProcessEnv {
		readonly SLN_TELEMETRY_DISABLED: string | undefined;
		...
		readonly NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS:
			| string
			| "help@stresslessness.org";
		readonly NEXT_PUBLIC_COMPANY_NAME: string | "stresslessness.org, Inc.";
		/**
		 *  "strict" -> Strict CSP
