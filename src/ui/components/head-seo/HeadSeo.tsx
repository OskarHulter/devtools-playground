...
import type { AppImageProps, MeetingImageProps } from "@sln/lib/OgImages";
import {
	constructAppImage,
	constructGenericImage,
	constructMeetingImage,
} from "@sln/lib/OgImages";
import { APP_NAME, CAL_URL } from "@sln/lib/constants";
import {
	buildCanonical,
	getSeoImage,
	seoConfig,
} from "@sln/lib/next-seo.config";
import { truncateOnWord } from "@sln/lib/text";
...
export const HeadSeo = (props: HeadSeoProps): JSX.Element => {
	...
	// Set the default URL to either the current URL (if self-hosted) or https://stresslessness.org canonical URL
