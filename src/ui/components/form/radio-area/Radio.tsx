...
export const Radio = (
	...
	<RadioGroupPrimitive.Item
		...
		className={classNames(
			"hover:bg-subtle border-default dark:checked:bg-brand-default dark:bg-darkgray-100 dark:hover:bg-subtle dark:checked:hover:bg-brand-default focus:ring-brand-default hover:border-emphasis me-1.5 mt-0.5 h-4 w-4 flex-shrink-0 rounded-full border text-[--sln-brand] focus:border-0 focus:ring-1",
