...
describe("Tests for InputField Component", () => {
	...
	test("Should handle input correctly", () => {
		const { getByRole } = render(
			<InputField name="testInput" onChange={onChangeMock} />,
		);
	...
	it("should display both addOnLeading and addOnSuffix", () => {
		const { getByText } = render(
			<InputField
				addOnLeading={<span>Leading</span>}
				addOnSuffix={<span>Suffix</span>}
			/>,
		);
...
describe("Tests for TextAreaField Component", () => {
	...
	test("Should handle input correctly", () => {
		const { getByRole } = render(
			<TextAreaField name="testTextArea" onChange={onChangeMock} />,
		);
...
describe("Tests for NumberInput Component", () => {
	...
	test("Should handle input correctly", () => {
		const { getByRole } = render(
			<NumberInput name="numberInput" onChange={onChangeMock} />,
		);
