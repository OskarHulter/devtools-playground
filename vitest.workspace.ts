...
const timeZoneDependentTestsOnly = process.argv.includes(
				...
				: [
...

						{
							test: {
								name: "@sln/closecom",
								include: [
									"packages/app-store/closecom/**/*.{test,spec}.{ts,js}",
								],
								environment: "jsdom",
						...
						},
						{
							test: {
								...
								include: [
									"packages/app-store/_components/**/*.{test,spec}.[jt]s?(x)",
								],
								environment: "jsdom",
